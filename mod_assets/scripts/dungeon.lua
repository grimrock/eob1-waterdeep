...
-- generated by EobConverter 0.9.9, but missing in dungeon.lua
spawn("eob_sewers_alcove", 10, 2, 2, "eob_sewers_alcove_105")
	:addItem(spawn("eob_gem_blue_u")) -- Gem 
...
spawn("eob_sewers_alcove", 9, 7, 1, "eob_sewers_alcove_107")
	:addItem(spawn("eob_arrow_u")) -- Arrow 
...
spawn("eob_sewers_wall_drainage", 25,18,2, "eob_sewers_wall_drainage_22")
	:setWallText("")
spawn("blocker", 19,9,2, "blocker_7") -- it was 19,8,3 but EobConverter claims it should be 19,9,2
...
spawn("starting_location", 20,23,0, "starting_location_1")
